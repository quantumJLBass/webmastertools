 ...
 * @package    Wsu_GATracking
 */
class Wsu_GATracking_Model_Observer
{
    /**
     ...
     *
     * @deprecated after 1.3.2.3 Use setGATrackingOnOrderSuccessPageView() method instead
     * @param Varien_Event_Observer $observer
     */
    public function order_success_page_view($observer)
    {
        $this->setGATrackingOnOrderSuccessPageView($observer);
    }
     ...
     * @param Varien_Event_Observer $observer
     */
    public function setGATrackingOnOrderSuccessPageView(Varien_Event_Observer $observer)
    {
    ...
    public function injectAnalyticsInGoogleCheckoutLink(Varien_Event_Observer $observer)
    {
        ...
        if (!$block || !Mage::helper('gatracking')->isGATrackingAvailable()) {
            return;
        }
